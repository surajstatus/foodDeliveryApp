  ...
  const handleAddToCart = async () => {
    ...
    if (food !== []) {
      if (food.size === size) {
        ...
        await dispatch({ type: "ADD", id: props.foodItem._id, name: props.foodItem.name, size: size, price: finalPrice, qty: qty })
        return
      }
      return
    }
